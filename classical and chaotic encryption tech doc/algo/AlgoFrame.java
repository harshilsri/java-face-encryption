...
public class AlgoFrame extends JFrame
{
    ...
    private void jbInit() throws Exception
    {
		...
		this.setTitle("Efficient Basic Access Control Policy" );
		int x=0,y=0;
		Dimension d = Toolkit.getDefaultToolkit().getScreenSize();
		x = d.width /2 - 550/2;
		y = d.height /2 - 400/2;
...
Statement st=con.createStatement();
	  PreparedStatement ps=con.prepareStatement("insert into file2 values(?,?)");
   String uname= jtfOutputFile.getText();
	 File file1 =new File(uname);
