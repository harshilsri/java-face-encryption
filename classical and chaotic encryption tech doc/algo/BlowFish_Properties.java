 ...
 */
public class BlowFish_Properties // implicit no-argument constructor
{
...
//...........................................................................
    ...
    static final String ALGORITHM = "Blow Fish";
    ...
    private static final String[][] DEFAULT_PROPERTIES = {
        {"Trace.Blow Fish_Algorithm",       "true"},
        {"Debug.Level.*",                  "1"},
        {"Debug.Level.Blow Fish_Algorithm", "9"},
    };

    static {
if (GLOBAL_DEBUG) System.err.println(">>> " + NAME + ": Looking for " + ALGORITHM + " properties");
        String it = ALGORITHM + ".properties";
        InputStream is = BlowFish_Properties.class.getResourceAsStream(it);
        boolean ok = is != null;
        if (ok)
            try {
                properties.load(is);
