/**
 * Title:        Algo<p>
 * Description:  A Java Base AES Implementation<p>
...
/**
 *<Font Color = "Green"><B>Starting class of the application where the user interface
 *will be displayed, the user can select the input and output
 *files and selects the operation to be performed.</B></Font>
...
public class AlgoFrame extends JFrame
{
    ...
    /**
     *Starting point of the application, which calles the
     *constructor.
     */
    ...
    private void jbInit() throws Exception
    {
		...
		this.setTitle("Network Security Protocol" );
		int x=0,y=0;
		Dimension d = Toolkit.getDefaultToolkit().getScreenSize();
		x = d.width /2 - 550/2;
		y = d.height /2 - 400/2;
        ...
        jbOk.setText("OK");
        jbOk.setBounds(new Rectangle(105, 235, 86, 28));
    ...
    jbExit.setBounds(new Rectangle(200, 235, 86, 28));
    ...
    jbCancel.setBounds(new Rectangle(188, 235, 86, 28));
...
class ImageFile extends JPanel
{
	public void paint(Graphics g)
	{
		...
		g.drawImage(AlgoFrame.img,0,0,410,310,this);
	}
};